...
inputs = readRDS("_data/2_setup.rds")

rsa = inputs$rsa
grid_sf = inputs$grid_sf
grid_spp = inputs$grid_spp
effRich_r = inputs$effRich_r
grid_spp_pa = inputs$grid_spp_pa
sp_cols = inputs$sp_cols
grid_r = terra::rast('D:/Methods/R/myR_Packages/b-cubed-versions/dissmapr/inst/extdata/grid_r.tif')
```
