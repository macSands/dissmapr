...
vignette: >
  %\VignetteIndexEntry{Get environmental data for sites}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

```{r child-3, child = "_common.Rmd"}
```
...
```{r load-env-rasters, include = FALSE}
grid_masked = terra::rast(system.file("extdata", "grid_masked.tif", package = "dissmapr"))
effRich_r = terra::rast(system.file("extdata", "effRich_r.tif", package = "dissmapr"))
```
