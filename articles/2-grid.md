...
#>   `/home/runner/.cache/R/renv/library/dissmapr-347017a9/linux-ubuntu-noble/R-4.6/x86_64-pc-linux-gnu/dissmapr/extdata/rsa.shp' 
...
#>  [67] future_1.75.0        desc_1.4.3           survival_3.8-6      
...
#>  [85] glue_1.8.1           clValid_0.7          emmeans_2.0.4       
...
#> [106] scam_1.2-22          lava_1.9.2           dplyr_1.2.1         
...
#> [118] htmltools_0.5.9      pkgdown_2.2.1        lifecycle_1.0.5     
#> [121] factoextra_2.1.0     hardhat_1.4.3        httr_1.4.8          
#> [124] MASS_7.3-65
```
