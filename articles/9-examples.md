...
![Distribution of √Species Richness by
Order](figures/9-richness-boxplot-1.png)
...
![√Species Richness](figures/9-richness-plot-1.png)

Plot order-wise richness (orders 2:5) calculated using
`compute_orderwise(..., func = richness, ...)` to visualise spatial
...
![Mean √Richness by Order](figures/9-richness-plot-orders2345-1.png)
...
![Beta Diversity](figures/9-turnover-plot-order2-1.png)
...
![Mean Turnover by Order](figures/9-turnover-plot-orders2345-1.png)
