...
#>   [4] gridExtra_2.3        permute_0.9-10       rlang_1.2.0         
...
#>  [25] jsonlite_2.0.0       recipes_1.3.3        parallel_4.5.2      
...
#>  [43] Matrix_1.7-5         splines_4.5.2        nnet_7.3-20         
#>  [46] timechange_0.4.0     tidyselect_1.2.1     rstudioapi_0.19.0   
#>  [49] yaml_2.3.12          vegan_2.7-5          timeDate_4052.112   
#>  [52] codetools_0.2-20     listenv_1.0.0        lattice_0.22-9      
#>  [55] tibble_3.3.1         plyr_1.8.9           withr_3.0.3         
#>  [58] S7_0.2.2             geosphere_1.6-8      evaluate_1.0.5      
#>  [61] future_1.70.0        desc_1.4.3           survival_3.8-6      
#>  [64] units_1.0-1          proxy_0.4-29         pillar_1.11.1       
#>  [67] KernSmooth_2.23-26   corrplot_0.95        renv_1.1.4          
#>  [70] foreach_1.5.2        stats4_4.5.2         generics_0.1.4      
#>  [73] scales_1.4.0         xtable_1.8-8         globals_0.19.1      
#>  [76] class_7.3-23         glue_1.8.1           clValid_0.7         
#>  [79] emmeans_2.0.3        tools_4.5.2          ModelMetrics_1.2.2.2
#>  [82] gower_1.0.2          mvtnorm_1.4-1        fs_2.1.0            
#>  [85] dotCall64_1.2        grid_4.5.2           ipred_0.9-15        
#>  [88] nlme_3.1-169         cli_3.6.6            rappdirs_0.3.4      
#>  [91] textshaping_1.0.5    NbClust_3.0.1        spam_2.11-4         
#>  [94] lava_1.9.1           gtable_0.3.6         sass_0.4.10         
#>  [97] digest_0.6.39        classInt_0.4-11      caret_7.0-1         
#> [100] ggrepel_0.9.8        htmlwidgets_1.6.4    farver_2.1.2        
#> [103] entropy_1.3.2        htmltools_0.5.9      pkgdown_2.2.0       
#> [106] lifecycle_1.0.5      factoextra_2.0.0     hardhat_1.4.3       
#> [109] MASS_7.3-65
```
