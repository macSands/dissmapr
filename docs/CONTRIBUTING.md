...
This outlines how to propose a change to templateB3. For a detailed
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("macSands/templateB3", fork = TRUE)`.
...
Please note that the templateB3 project is released with a [Contributor
Code of
