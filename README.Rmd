...
```{r make‐savedata‐dir, echo=FALSE}
# Ensure “inst/savedata/” exists before trying to save into it
dir.create("inst/savedata", recursive = TRUE, showWarnings = FALSE)
```

```{r save‐all, echo=FALSE}
# Save what vignette-grid needs
save(
  site_spp,
  rsa,
  sp_cols,
  file = "inst/savedata/grid_workspace.RData"
)

# Save what vignette-enviro needs
save(
  sbs,
  ras_effRich,
  xy,
  file = "inst/savedata/enviro_workspace.RData"
)

# Save what vignette-zeta needs
save(
  site_spp_pa,
  xy_utm_df,
  env_vars_reduced,
  xy,
  file = "inst/savedata/zeta_workspace.RData"
)

# Save what vignette-bioregion needs
save(
  grid_spp,
  sbe,
  zeta2,
  ...
  rsa,
  grid_masked,
  file = "inst/savedata/bioregion_workspace.RData"
)

# Save what vignette-examples needs
save(
  grid_spp,
  sp_cols,
  rsa,
  file = "inst/savedata/examples_workspace.RData"
)
```
