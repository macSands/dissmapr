...
#' @param cell_size Numeric. Size of the grid cell. For example, 1 for 1° cells, 15 for 15' cells.
#' @param unit Character. One of "deg", "min", "sec", or "m". For geographic data use "deg" (default).
#'
#' @return The original data frame with three additional columns:
#'   \item{mapsheet}{The mapsheet code in the format "[E|W]DDD[N|S]DDBB".}
